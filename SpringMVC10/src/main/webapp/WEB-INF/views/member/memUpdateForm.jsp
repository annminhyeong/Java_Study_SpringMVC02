    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form name="frm" action="${contextPath}/memUpdate.do" method="post">
          ...
          <input id="memID" name="memID" type="hidden" value="${mvo.member.memID}">
          ...
          <table class="table table-bordered text-center">
            ...
            <tr>
              ...
              <td colspan="2"><input id="memName" name="memName" type="text" maxlength="20" placeholder="이름을 입력하세요" value="${mvo.member.memName}" class="form-control"></td>
            </tr>
            <tr>
              <td style="width: 110px; vertical-align: middle;">나이</td>
              <td colspan="2"><input id="memAge" name="memAge" type="number" maxlength="3" placeholder="나이을 입력하세요" value="${mvo.member.memAge}"  class="form-control"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2"><input id="memEmail" name="memEmail" type="text" maxlength="20" placeholder="이메일을 입력하세요" value="${mvo.member.memEmail}" class="form-control"></td>
            </tr>
            <tr>
              ...
              <td colspan="2">
                ...
                <security:authorize access="hasRole('ROLE_MANAGER')">checked</security:authorize>
                />ROLE_MANAGER
                <input type="checkbox" name="authList[2].auth" value="ROLE_ADMIN"
                <security:authorize access="hasRole('ROLE_ADMIN')">checked</security:authorize>
               />ROLE_ADMIN
              </td>
            </tr>
            <tr>
